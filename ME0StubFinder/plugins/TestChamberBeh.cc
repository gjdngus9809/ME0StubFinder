...
void TestChamberBeh::analyze(const edm::Event &iEvent,
    ...
    SingleSC[2] = {0b110000, 0b110000, 0b110000, 0b110000, 0b110000, 0b110000};
    for (auto i : SingleSC) {
        for (auto j : i) {
    ...
    std::cout << seglist0[0].bend_ang << " " << seglist0[0].strip << " " << seglist0[0].id << " " << seglist0[0].lc << std::endl;
    std::cout << seglist0[1].bend_ang << " " << seglist0[1].strip << " " << seglist0[1].id << " " << seglist0[1].lc << std::endl;
    std::cout << seglist0[2].bend_ang << " " << seglist0[2].strip << " " << seglist0[2].id << " " << seglist0[2].lc << std::endl;
    std::cout << seglist0[3].bend_ang << " " << seglist0[3].strip << " " << seglist0[2].id << " " << seglist0[2].lc << std::endl;
}
