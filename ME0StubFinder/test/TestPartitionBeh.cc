...
void TestPartitionBeh::analyze(const edm::Event &iEvent,
	...
	*/
    ...
    std::vector<ME0Stub> mux = process_partition(data, 0, config);
    ...
    ME0Stub seg1(6, 6, 15, 0, 0);
    ME0Stub seg2(6, 6, 10, 0, 0);
    ME0Stub seg3(6, 6, 7,  0, 0);
    ...
    std::vector<ME0Stub> segments;
    for (int i=0; i<24; ++i) {
        segments.push_back(ME0Stub(6, 6, 15, i, 0));
    }

    std::vector<ME0Stub> cancelled = cancel_edges(segments, 8, 2);
